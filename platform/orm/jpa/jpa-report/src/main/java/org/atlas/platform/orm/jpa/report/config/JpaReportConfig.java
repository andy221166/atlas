package org.atlas.platform.orm.jpa.report.config;
 ...
 */
@Configuration
@EntityScan(basePackages = "org.atlas.platform.orm.jpa.report.entity")
@EnableJpaRepositories(
    basePackages = "org.atlas.platform.orm.jpa.report.repository",
