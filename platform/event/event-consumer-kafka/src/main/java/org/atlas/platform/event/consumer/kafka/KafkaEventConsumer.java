...
@Component
@ConditionalOnExpression("T(org.apache.commons.collections4.CollectionUtils).isNotEmpty('#{kafkaEventConsumerProps.topics}')")
...
public class KafkaEventConsumer {
  ...
  @KafkaListener(
      topics = "#{kafkaEventConsumerProps.topics}",
