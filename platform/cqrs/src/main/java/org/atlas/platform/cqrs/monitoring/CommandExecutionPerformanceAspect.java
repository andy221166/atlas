  ...
  public Object aroundHandle(ProceedingJoinPoint joinPoint) throws Throwable {
    ...
    try {
      ...
      if (timeElapsed <= acceptedMaxExecutionTime) {
        log.info("Finished executing command {}#{}. Elapsed time: {} ms.", className, methodName,
            timeElapsed);
      } else {
        log.warn(
            "Finished executing command {}#{}. Elapsed time: {} ms ===> Exceeded the maximum time, please check its performance!!!",
