...
public class UserGrpcService extends UserServiceGrpc.UserServiceImplBase {
  ...
  public void listUser(ListUserRequestProto requestProto,
    ...
    ListUserBulkQuery query = map(requestProto);
    try {
  ...
  private ListUserBulkQuery map(ListUserRequestProto requestProto) {
    return new ListUserBulkQuery(requestProto.getUserIdList());
  }
