...
public class UserController {
    ...
    @GetMapping
    public RestResponse<List<UserDto>> listUser(@RequestParam("ids") List<Integer> ids) throws Exception {
        ListUserQuery query = new ListUserQuery(ids);
    ...
    @PostMapping("/sign-in")
    public RestResponse<SignInResDto> signIn(@Valid @RequestBody SignInCommand command) throws Exception {
        return RestResponse.success(commandGateway.send(command));
    }
    ...
    public RestResponse<Void> signOut(@RequestHeader(HttpHeaders.AUTHORIZATION) String authorizationHeader) throws Exception {
