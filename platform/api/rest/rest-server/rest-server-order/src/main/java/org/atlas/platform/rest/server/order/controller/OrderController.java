...
public class OrderController {
    ...
    @GetMapping("/export")
    public ResponseEntity<byte[]> export(@RequestParam("fileType") FileType fileType) throws Exception {
        ...
        String fileName = "export-order-" + DateUtil.now("yyyyMMddHHmmss") + "." + command.getFileType().getExtension();
