...
public class RestTemplateConfig {
    ...
    /**
     * As the {@link RestLoggingRequestInterceptor} consumes the response stream, our client application will see an empty response body.
    ...
    public RestTemplate restTemplate(RestTemplateBuilder builder) {
        return builder.requestFactory(() -> new BufferingClientHttpRequestFactory(new SimpleClientHttpRequestFactory()))
            .additionalInterceptors(new RestLoggingRequestInterceptor())
