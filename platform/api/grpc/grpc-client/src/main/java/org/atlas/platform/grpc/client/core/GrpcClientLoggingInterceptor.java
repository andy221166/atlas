package org.atlas.platform.grpc.client.core;
                ...
                super.start(
                    new ForwardingClientCallListener.SimpleForwardingClientCallListener<RespT>(responseListener) {
                        ...
                        public void onClose(Status status, Metadata trailers) {
                            ...
                            if (status.isOk()) {
                                log.info("Call to {} completed successfully in {}ms", method.getFullMethodName(), duration);
                            } else {
                                log.error("Call to {} failed with status: {} after {}ms", method.getFullMethodName(), status, duration);
                            }
