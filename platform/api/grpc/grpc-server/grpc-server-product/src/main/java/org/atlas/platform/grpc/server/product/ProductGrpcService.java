...
public class ProductGrpcService extends ProductServiceGrpc.ProductServiceImplBase {
  ...
  public void listProduct(ListProductRequestProto requestProto,
    ...
    ListProductQuery command = map(requestProto);
    try {
  ...
  private ListProductQuery map(ListProductRequestProto requestProto) {
    return new ListProductQuery(requestProto.getIdList());
  }
