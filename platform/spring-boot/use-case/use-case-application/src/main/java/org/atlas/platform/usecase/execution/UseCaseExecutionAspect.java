package org.atlas.platform.usecase.execution;
...
import org.atlas.platform.usecase.interceptor.Interceptor;
...
public class UseCaseExecutionAspect {
  ...
  @Around("execution(* org.atlas.platform.usecase.port.UseCase.handle(..))")
