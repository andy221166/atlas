...
import org.atlas.platform.persistence.jdbc.product.supports.ProductRowMapper;
...
public class JdbcProductRepository {
    ...
    private String buildWhereClause(SearchProductQuery query, MapSqlParameterSource params) {
        ...
        if (StringUtils.hasLength(query.getKeyword())) {
            whereClauseBuilder.append(" and (lower(p.name) like :keyword or lower(description) like :keyword) ");
