package org.atlas.platform.persistence.jpa.product.config;
 ...
 */
@Configuration
@EntityScan(basePackages = "org.atlas.platform.persistence.jpa.product.entity")
@EnableJpaRepositories(
    basePackages = "org.atlas.platform.persistence.jpa.product.repository",
