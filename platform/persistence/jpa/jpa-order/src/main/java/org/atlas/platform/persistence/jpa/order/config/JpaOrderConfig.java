package org.atlas.platform.persistence.jpa.order.config;
 ...
 */
@Configuration
@EntityScan(basePackages = "org.atlas.platform.persistence.jpa.order.entity")
@EnableJpaRepositories(
    basePackages = "org.atlas.platform.persistence.jpa.order.repository",
