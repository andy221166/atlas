...
public class QueryFilter {
    ...
    public static class Condition {
        ...
        public static Condition of(@Nonnull String key, @Nonnull Object value, @Nonnull QueryOperator queryOperator) {
            return new Condition(key, value, queryOperator);
        }
    }

    public static QueryFilter of(@Nonnull String key, @Nonnull Object value, @Nonnull QueryOperator queryOperator) {
