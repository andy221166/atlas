package org.atlas.platform.orm.jpa.orderEntity.repository;

import java.util.Date;
import java.util.List;
import java.util.Optional;
import org.atlas.platform.orm.jpa.orderEntity.entity.JpaOrder;
import org.atlas.platform.persistence.jpa.core.repository.JpaBaseRepository;
import org.atlas.service.orderEntity.contract.model.OrderStatusStatisticsDto;
...
public interface JpaOrderRepository extends JpaBaseRepository<JpaOrder, Integer> {
  ...
  @Query("""
      select new org.atlas.service.orderEntity.contract.model.OrderStatusStatisticsDto(
          o.status,
          count(o.id),
          sum(o.amount)
      )
