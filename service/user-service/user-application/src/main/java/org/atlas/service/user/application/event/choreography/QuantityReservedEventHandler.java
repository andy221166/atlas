...
import org.atlas.platform.event.core.contract.order.choreography.CreditReservedEvent;
import org.atlas.platform.event.core.contract.order.choreography.QuantityReservedEvent;
import org.atlas.platform.event.core.contract.order.choreography.ReserveCreditFailedEvent;
...
public class QuantityReservedEventHandler implements EventHandler<QuantityReservedEvent> {
    ...
    public void handle(QuantityReservedEvent quantityReservedEvent) {
        ...
        int reserveCreditResult = customerRepository.decreaseCredit(order.getUser().getId(), order.getAmount());
