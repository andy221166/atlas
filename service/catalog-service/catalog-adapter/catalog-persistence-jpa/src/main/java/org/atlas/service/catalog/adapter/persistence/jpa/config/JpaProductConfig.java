 ...
 */
@Configuration
@EntityScan(basePackages = "org.atlas.service.product.adapter.persistence.jpa.entity")
@EnableJpaRepositories(
    basePackages = "org.atlas.service.product.adapter.persistence.jpa.repository",
