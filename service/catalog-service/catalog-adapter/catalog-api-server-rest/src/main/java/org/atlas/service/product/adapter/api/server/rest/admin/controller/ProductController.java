...
import org.atlas.service.catalog.port.inbound.admin.CreateProductUseCase;
import org.atlas.service.catalog.port.inbound.admin.DeleteProductUseCase;
...
public class ProductController {
    ...
    @PostMapping
    public Response<CreateProductUseCase.Output> createProduct(@Valid @RequestBody CreateProductRequest request) throws Exception {
        CreateProductUseCase.Input input = ObjectMapperUtil.getInstance().map(request, CreateProductUseCase.Input.class);
    ...
    public Response<Void> updateProduct(
        ...
        UpdateProductUseCase.Input input = ObjectMapperUtil.getInstance().map(request, UpdateProductUseCase.Input.class);
        input.setId(id);
