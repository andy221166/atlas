package org.atlas.service.user.adapter.persistence.jpa.config;
 ...
 */
@Configuration
@EntityScan(basePackages = "org.atlas.service.user.adapter.persistence.jpa.entity")
@EnableJpaRepositories(
    basePackages = "org.atlas.service.user.adapter.persistence.jpa.repository",
