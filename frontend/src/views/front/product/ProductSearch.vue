    ...
    <div v-if="products.length" class="mt-4 row g-3">
      <div v-for="product in products" :key="product.id" class="col-md-4">
        <div class="card h-100 shadow-sm">
          <img :src="product.image" class="card-img-top product-image" :alt="product.name" @error="handleImageError" />
...
import { searchProduct } from "@/services/product/product.front.service";
import type { Brand, Category } from "@/services/product/product.common.interface";
import type { Product, SearchProductFilters } from "@/services/product/product.front.interface";
...
const handleImageError = (event: Event) => {
  (event.target as HTMLImageElement).src = require("@/assets/product-placeholder.jpg");
};
