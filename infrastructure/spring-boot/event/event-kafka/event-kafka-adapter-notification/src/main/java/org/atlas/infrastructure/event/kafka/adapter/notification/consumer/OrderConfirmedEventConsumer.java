package org.atlas.infrastructure.event.kafka.adapter.notification.consumer;
...
@Slf4j
public class OrderConfirmedEventConsumer extends KafkaEventConsumer {

  private final OrderConfirmedEventHandler orderConfirmedEventHandler;

  @Override
  @KafkaListener(
      topics = "#{kafkaEventProps.topic.orderConfirmedEvent}",
